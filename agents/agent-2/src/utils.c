...
{
    agent->id = 2; // This has to change between agents
    agent-> start_me = 0;
    ...
    agent->nodes[2][1].semaphores[0] = LED_21U;
    agent->nodes[2][1].semaphores[1] = LED_21R;
    agent->nodes[2][1].semaphores[2] = LED_21D;
    agent->nodes[2][1].semaphores[3] = LED_21L;
    agent->nodes[2][1].sensor = 4;
    agent->nodes[2][1].sem_locked = false; 
    agent->nodes[2][1].sem_status[0] = false; // up
    agent->nodes[2][1].sem_status[1] = false; // right
    agent->nodes[2][1].sem_status[2] = false; // down
    agent->nodes[2][1].sem_status[3] = false; // left
