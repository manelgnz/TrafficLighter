...
// INTERSECTION 21
const int LED_21U = 31;   
const int LED_21R = 26;   
const int LED_21D = 27;   
const int LED_21L = 28;   
const int SENSOR_21 = 29; 
...
void initialize_pins(){
    ...
    pinMode(LED_21U, OUTPUT);
    digitalWrite(LED_21U, LOW);
    pinMode(LED_21R, OUTPUT);
    digitalWrite(LED_21R, LOW);
    pinMode(LED_21D, OUTPUT);
    digitalWrite(LED_21D, LOW);
    pinMode(LED_21L, OUTPUT);
    digitalWrite(LED_21L, LOW);
    pinMode(SENSOR_21, INPUT);
    pullUpDnControl(SENSOR_21, PUD_UP);
    wiringPiISR(SENSOR_21, INT_EDGE_RISING, &sensor_21_handler);  // Set interruption
